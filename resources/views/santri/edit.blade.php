...
@section('container')
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Edit Data Santri</div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('santri.update', $santri->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_masuk" name="tanggal_masuk"
                                    value="{{ old('tanggal_masuk', $santri->tanggal_masuk) }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            @if (auth()->user()->role == 'admin')
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="unit" name="unit" required>
                                        ...
                                        <option value="putra"
                                            {{ old('unit', $santri->unit) == 'putra' ? 'selected' : '' }}>Putra</option>
                                        <option value="putri"
                                            {{ old('unit', $santri->unit) == 'putri' ? 'selected' : '' }}>Putri</option>
                                    </select>
                                </div>
                            @endif
